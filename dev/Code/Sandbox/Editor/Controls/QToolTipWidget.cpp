...
void QToolTipWidget::TryDisplay(QPoint mousePos, const QRect& rect, ArrowDirection preferredArrowDir)
{
...
void QToolTipWidget::QArrow::paintEvent(QPaintEvent* event)
{
