...
%QTDIR%\lupdate -noobsolete ..\..\Plugins\EditorAnimation 						-ts 	.\EditorAnimation_zh-cn.ts
%QTDIR%\lupdate -noobsolete ..\..\Plugins\EditorModularBehaviorTree				-ts 	.\EditorModularBehaviorTree_zh-cn.ts
...
%QTDIR%\lupdate -noobsolete ..\..\..\..\Gems\SceneProcessing 					-ts 	.\SceneProcessing_zh-cn.ts
