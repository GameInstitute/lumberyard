...
void PropertyRow::updateLabel(const QPropertyTree* tree, int index, bool parentHidesNonInlineChildren)
{
	if (!labelChanged_) {
		if (pulledUp_)
...
bool PropertyRow::processesKey(QPropertyTree* tree, const QKeyEvent* ev)
{
...
QRect PropertyRow::validatorRect(const QPropertyTree* tree) const
{
...
*/
#include <QPropertyTree/PropertyRow.moc>
