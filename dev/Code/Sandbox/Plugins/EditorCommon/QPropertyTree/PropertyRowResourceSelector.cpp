...
#include <ICryAnimation.h> // for ICharacterInstance in context
...
void PropertyRowResourceSelector::jumpTo(QPropertyTree* tree)
{
    if (multiValue())
    {
        return;
...
#include <QPropertyTree/PropertyRowResourceSelector.moc>
