...
public:
    ...
    QMenu* GetTreeContextMenu() override
    {
        ...
        auto deleteResource = menu->addAction(QObject::tr("Delete resource"));
        ...
        if (functionId != "")
        {
            ...
            auto viewCloudWatchLogs = menu->addAction(QObject::tr("View Cloud Watch Logs"));
...
protected:
    ...
    void OnDeleteResourceRequested()
    {
        ...
        dialog.setWindowTitle(QObject::tr("Delete resource"));
        ...
        QString deleteString(QObject::tr("Delete the \"") + m_resourceSection + QObject::tr("\" resource?"));
