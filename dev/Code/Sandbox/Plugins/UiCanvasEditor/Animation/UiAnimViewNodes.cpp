...
//////////////////////////////////////////////////////////////////////////
int CUiAnimViewNodesCtrl::GetIconIndexForTrack(const CUiAnimViewTrack* pTrack) const
{
...
int CUiAnimViewNodesCtrl::ShowPopupMenuSingleSelection(UiAnimContextMenu& contextMenu, CUiAnimViewSequence* pSequence, CUiAnimViewNode* pNode)
{
    ...
    if (bOnNode && !pNode->IsGroupNode())
    {
        ...
        for (unsigned int childIndex = 0; childIndex < numChildren; ++childIndex)
        {
            ...
            {
                CUiAnimViewTrack* pTrack = static_cast<CUiAnimViewTrack*>(pChild);
...
//////////////////////////////////////////////////////////////////////////
int CUiAnimViewNodesCtrl::ShowPopupMenu(QPoint point, const CRecord* pRecord)
{
    CUiAnimViewSequence* pSequence = nullptr;
    EBUS_EVENT_RESULT(pSequence, UiEditorAnimationBus, GetCurrentSequence);
    if (!pSequence)
...
void CUiAnimViewNodesCtrl::keyPressEvent(QKeyEvent* event)
{
}

void CUiAnimViewNodesCtrl::CreateSetAnimationLayerPopupMenu(QMenu& menuSetLayer, CUiAnimViewTrack* pTrack) const
{
...
//////////////////////////////////////////////////////////////////////////
void CUiAnimViewNodesCtrl::OnNodeRenamed(CUiAnimViewNode* pNode, const char* pOldName)
{
    if (!m_bIgnoreNotifications)
    {
        CRecord* pNodeRecord = GetNodeRecord(pNode);
...
#include <Animation/UiAnimViewNodes.moc>
