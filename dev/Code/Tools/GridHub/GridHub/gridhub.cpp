...
// [7/6/2012]
//=========================================================================
void GridHub::timerEvent(QTimerEvent *event)
{
    m_componentApp->Tick();
...
//=========================================================================
void 
GridHubComponent::OnMemberJoined(GridMate::GridSession* session, GridMate::GridMember* member)
{
...
//=========================================================================
void 
GridHubComponent::OnMemberLeaving(GridMate::GridSession* session, GridMate::GridMember* member)
{
    GridMate::MemberIDCompact id = member->GetId().Compact();
    for(size_t i = 0; i < m_monitored.size(); ++i )
    {
...
//=========================================================================
void 
GridHubComponent::OnSessionDelete(GridMate::GridSession* session)
{
    AZ_Assert(m_session==session,"Session missmatch!");
    m_session = nullptr;
}
