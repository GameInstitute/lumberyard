...
namespace LUAEditor
{
    ...
    LUAEditor::Context* s_pLUAEditorScriptPtr = NULL; // for script access
    ...
    void Context::Activate()
    {
        ...
        LyMetrics_SendEvent(LuaIDEMetrics::Category::EventName, { { LuaIDEMetrics::Operation, LuaIDEMetrics::Events::OpenEditor } });
    }

    void Context::Deactivate()
    {
        LyMetrics_SendEvent(LuaIDEMetrics::Category::EventName, { { LuaIDEMetrics::Operation, LuaIDEMetrics::Events::CloseEditor } });
            ...
            if (m_fileIO && !info.m_bUntitledDocument)
            {
                ...
                else
                {
                    ...
                    if (!info.m_bSourceControl_BusyGettingStats)
                    {
                        ...
                        // because we've already given the go-ahead to exit Woodpecker
                        if (!m_bShuttingDown)
                        {
                            {
    ...
    void Context::DesiredTargetConnected(bool connected)
    {
        ...
        if (connected)
        {
            ...
            LyMetrics_SendEvent(LuaIDEMetrics::Category::EventName, { { LuaIDEMetrics::Operation, LuaIDEMetrics::Events::TargetConnected } });
        ...
        else
        {
            ...
            LyMetrics_SendEvent(LuaIDEMetrics::Category::EventName, { { LuaIDEMetrics::Operation, LuaIDEMetrics::Events::TargetDisconnected } });
        }
    }
    ...
    void Context::OnSaveDocument(const AZStd::string& assetId, bool bCloseAfterSave, bool bSaveAs)
    {
        ...
        if (isSaved)
        {
            if (newFileCreated)
            {
                ...
                LyMetrics_SendEvent(LuaIDEMetrics::Category::EventName, { { LuaIDEMetrics::Operation, LuaIDEMetrics::Events::FileCreated } });

                DocumentCheckOutRequested(normalizedAssetId);
            }
            else
            {
                LyMetrics_SendEvent(LuaIDEMetrics::Category::EventName, { { LuaIDEMetrics::Operation, LuaIDEMetrics::Events::FileSaved } });
            }
        }
    ...
    void Context::DataLoadDoneCallback(bool success, const AZStd::string& assetId)
    {
        ...
        if (success)
        {
            ...
            LyMetrics_SendEvent(LuaIDEMetrics::Category::EventName, { { LuaIDEMetrics::Operation, LuaIDEMetrics::Events::FileOpened } });
    ...
    void Context::OnDebuggerAttached()
    {
        ...
        LyMetrics_SendEvent(LuaIDEMetrics::Category::EventName, { { LuaIDEMetrics::Operation, LuaIDEMetrics::Events::StartDebugger } });
    ...
    void Context::OnDebuggerRefused()
    {
        ...
        LyMetrics_SendEvent(LuaIDEMetrics::Category::EventName, { { LuaIDEMetrics::Operation, LuaIDEMetrics::Events::DebuggerRefused } });
    }
    ...
    void Context::OnDebuggerDetached()
    {
        ...
        LyMetrics_SendEvent(LuaIDEMetrics::Category::EventName, { { LuaIDEMetrics::Operation, LuaIDEMetrics::Events::StopDebugger } });
    }
