        ...
        : QDialog(parent)
    {
        ...
        for (size_t i = 0; i < numFiles; ++i)
        {
            ...
            switch (EMotionFX::GetImporter().CheckFileType(backupFilename.c_str()))
            {
                ...
                case EMotionFX::Importer::FILETYPE_SKELETALMOTION:
                    fileTypeString = "Skeletal Motion";
                    break;

                case EMotionFX::Importer::FILETYPE_WAVELETSKELETALMOTION:
                    fileTypeString = "Wavelet Skeletal Motion";
                    break;

                case EMotionFX::Importer::FILETYPE_PMORPHMOTION:
                    fileTypeString = "Morph Motion";
                    break;
...
#include <EMotionFX/Tools/EMotionStudio/EMStudioSDK/Source/RecoverFilesWindow.moc>