...
namespace EMStudio
{
    ...
    {
        mAccepted = false;
        setWindowTitle(QObject::tr("Parameter Selection Window"));
...
#include <EMotionFX/Tools/EMotionStudio/Plugins/StandardPlugins/Source/AnimGraph/ParameterSelectionWindow.moc>
