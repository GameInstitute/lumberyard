...
namespace EMStudio
{
    ...
    void PhonemeSelectionWindow::Init()
    {
        ...
        EMStudioManager::MakeTransparentButton(mAddPhonemesButtonArrow,    "/Images/Icons/PlayForward.png",    "Assign the selected phonemes to the morph target.");
        EMStudioManager::MakeTransparentButton(mRemovePhonemesButtonArrow, "/Images/Icons/PlayBackward.png",   "Unassign the selected phonemes from the morph target.");
        EMStudioManager::MakeTransparentButton(mAddPhonemesButton,         "/Images/Icons/Plus.png",           "Assign the selected phonemes to the morph target.");
        EMStudioManager::MakeTransparentButton(mRemovePhonemesButton,      "/Images/Icons/Minus.png",          "Unassign the selected phonemes from the morph target.");
        EMStudioManager::MakeTransparentButton(mClearPhonemesButton,       "/Images/Icons/Clear.png",          "Unassign all phonemes from the morph target.");
...
#include <EMotionFX/Tools/EMotionStudio/Plugins/StandardPlugins/Source/MorphTargetsWindow/PhonemeSelectionWindow.moc>