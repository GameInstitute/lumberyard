...
namespace EMStudio
{
    ...
    void NodeGroupWidget::Init()
    {
        ...
        EMStudioManager::MakeTransparentButton(mSelectNodesButton, "/Images/Icons/Plus.png",   "Select nodes and replace the current selection");
        EMStudioManager::MakeTransparentButton(mAddNodesButton,    "/Images/Icons/Plus.png",   "Select nodes and add them to the current selection");
        EMStudioManager::MakeTransparentButton(mRemoveNodesButton, "/Images/Icons/Minus.png",  "Remove selected nodes from the list");
...
#include <EMotionFX/Tools/EMotionStudio/Plugins/StandardPlugins/Source/NodeGroups/NodeGroupWidget.moc>