...
namespace EMStudio
{
    ...
    // save dirty actor
    int SceneManagerPlugin::SaveDirtyActor(EMotionFX::Actor* actor, MCore::CommandGroup* commandGroup, bool askBeforeSaving, bool showCancelButton)
    {
...
#include <EMotionFX/Tools/EMotionStudio/Plugins/StandardPlugins/Source/SceneManager/SceneManagerPlugin.moc>