...
namespace EMotionFX
{
    AZ_CLASS_ALLOCATOR_IMPL(BlendSpaceMotionWidget, AZ::SystemAllocator, 0)
    AZ_CLASS_ALLOCATOR_IMPL(BlendSpaceMotionContainerWidget, AZ::SystemAllocator, 0)
    AZ_CLASS_ALLOCATOR_IMPL(BlendSpaceMotionContainerHandler, AZ::SystemAllocator, 0)
    ...
    BlendSpaceMotionContainerWidget::BlendSpaceMotionContainerWidget(BlendSpaceNode* blendSpaceNode, QWidget* parent)
        : QWidget(parent)
    ...
    void BlendSpaceMotionContainerHandler::ConsumeAttribute(BlendSpaceMotionContainerWidget* GUI, AZ::u32 attrib, AzToolsFramework::PropertyAttributeReader* attrValue, const char* debugName)
    {
        if (attrValue)
        {
    ...
    void BlendSpaceMotionContainerHandler::WriteGUIValuesIntoProperty(size_t index, BlendSpaceMotionContainerWidget* GUI, property_t& instance, AzToolsFramework::InstanceDataNode* node)
    {
        instance = GUI->GetMotions();
    }


    bool BlendSpaceMotionContainerHandler::ReadValuesIntoGUI(size_t index, BlendSpaceMotionContainerWidget* GUI, const property_t& instance, AzToolsFramework::InstanceDataNode* node)
    {
...
#include <Source/Editor/PropertyWidgets/BlendSpaceMotionContainerHandler.moc>
