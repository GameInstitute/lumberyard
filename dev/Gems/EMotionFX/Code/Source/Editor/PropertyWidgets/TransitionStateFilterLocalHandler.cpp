...
namespace EMotionFX
{
    ...
    void TransitionStateFilterLocalHandler::ConsumeAttribute(TransitionStateFilterPicker* GUI, AZ::u32 attrib, AzToolsFramework::PropertyAttributeReader* attrValue, const char* debugName)
    {
    ...
    void TransitionStateFilterLocalHandler::WriteGUIValuesIntoProperty(size_t index, TransitionStateFilterPicker* GUI, property_t& instance, AzToolsFramework::InstanceDataNode* node)
    {
        instance = GUI->GetStateFilter();
    }


    bool TransitionStateFilterLocalHandler::ReadValuesIntoGUI(size_t index, TransitionStateFilterPicker* GUI, const property_t& instance, AzToolsFramework::InstanceDataNode* node)
    {
...
#include <Source/Editor/PropertyWidgets/TransitionStateFilterLocalHandler.moc>