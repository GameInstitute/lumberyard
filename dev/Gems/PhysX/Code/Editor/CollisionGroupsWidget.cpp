...
namespace PhysX
{
    namespace Editor
    {
        ...
        Physics::CollisionGroups::Id RowHeader::GetGroupId() const
        {
        ...
        void CollisionGroupsWidget::SetValue(const Physics::CollisionGroups& groups, const Physics::CollisionLayers& layers)
        {
            blockSignals(true);
            m_groups = groups;
            m_layers = layers;
        ...
        const Physics::CollisionGroups& CollisionGroupsWidget::GetValue() const
        {
            return m_groups;
        }
        ...
        void CollisionGroupsWidget::RemoveGroupTableView(Physics::CollisionGroups::Id groupId)
        {
        ...
        {
            m_groups.CreateGroup("NewGroup", Physics::CollisionGroup::All, Physics::CollisionGroups::Id::Create(), false);
            AddGroupTableView();
            emit onValueChanged(m_groups);
        }

        void CollisionGroupsWidget::RemoveGroup(Physics::CollisionGroups::Id groupId)
        {
        ...
        void CollisionGroupsWidget::RenameGroup(Physics::CollisionGroups::Id groupId, const AZStd::string& newName)
        {
            m_groups.SetGroupName(groupId, newName);
            emit onValueChanged(m_groups);
        }

        void CollisionGroupsWidget::EnableLayer(Physics::CollisionGroups::Id groupId, const Physics::CollisionLayer& layer, bool enabled)
        {
        ...
        AZStd::vector<ColumnHeader::Data> CollisionGroupsWidget::GetColumns()
        {
            ...
            for(AZ::u8 i = 0; i < Physics::CollisionLayers::s_maxCollisionLayers; ++i)
            {
...
#include <Editor/CollisionGroupsWidget.moc>